								...
								<section className="hero">
									...
									<div className="hero-text">
										<div className="eyebrow">
											...
											<span>
												Africa&apos;s Premier School Placement Consultants
											</span>
										</div>
										<h1>
											Where African
									...
									<div className="hero-caption">
										<span className="hero-caption-school">
											&quot;The finest schools in the world are waiting for
											Africa&apos;s finest students.&quot;
										</span>
										...
										<div className="mission-grid">
											...
											<div className="m-copy reveal d2">
												...
												<blockquote>
													...
													most gifted young minds. Our job is simply to make
													sure the world sees them.&quot;
												</blockquote>
												<div className="pillars">
													<div className="pil">
														...
														<p>
															Seasoned consultants with insider school knowledge
														</p>
													</div>
													<div className="pil">
														<span>🌍</span>
														...
														<p>
															Deep understanding of African students &amp;
															families
														</p>
													</div>
													<div className="pil">
								...
								<section className="stories" id="stories">
									<div className="s-inner">
										<div className="s-top reveal">
											...
											<p>
												Every student we place carries a story of ambition,
												resilience, and the courage to reach beyond what was
												...
												{[
													{
														...
														name: "Amaka O.",
														school: "Earlscliffe School · Full Scholarship",
														tag: "Class of 2023",
													},
													{
														...
														name: "Kofi A.",
														school: "Mander Poortman Woodward",
														tag: "Class of 2023",
													},
													{
														img: "/images/gina_marge_1.jpg",
														country: "South Africa → Hungary",
														name: "Zola D.",
													...
													},
													{
														...
														country: "Nigeria → Malta",
														name: "Emmanuel T.",
														school: "Ascencia Malta Business School",
														tag: "Class of 2025",
													},
												].map((s, i) => (
								...
								<section className="services" id="services">
									<div className="si">
										<div className="svc-top reveal">
											...
											<p>
												From first assessment to settling in abroad, we handle
												every detail so your family can focus on the excitement
												of what lies ahead.
											</p>
										</div>
