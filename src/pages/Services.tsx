					...
					<div className="svc-lay">
						<div className="svc-feat reveal">
							...
							<div className="svc-ft">
								...
								<p>
									...
									and ambitions to a curated shortlist of schools and then help
									them build applications that leave lasting impressions on
									admissions offices worldwide.
								</p>
							</div>
						</div>
						<div className="svc-gr">
							<div className="sv reveal d1">
								...
								<p>
									Rigorous mock interviews build confidence and communication
									skills to impress any admissions panel.
								</p>
							</div>
							<div className="sv reveal d2">
								...
								<p>
									We identify and pursue every scholarship opportunity to make
									an elite global education financially achievable.
								</p>
							</div>
							<div className="sv reveal d3">
								...
								<p>
									From documentation to embassy prep, we make student visa
									applications smooth and stress-free for the whole family.
								</p>
							</div>
							<div className="sv reveal d4">
								...
								<p>
									We don&apos;t disappear at acceptance. Ongoing support ensures
									your student thrives from day one abroad.
								</p>
							</div>
						</div>
					</div>
			...
			<section className="mission">
				<div className="si">
					...
					>
						...
						<p>
							Every family we serve receives the same level of attention and
							expertise. We guide you through each step with clarity, care, and
							a commitment to finding the very best fit for your child&apos;s
							unique potential.
						</p>
					</div>
				</div>
